angular.module('luae_na').factory('aktivitetsersattning-na.FormFactory', ['luae_na.FormFactoryHelper', function(FactoryHelper) {
    'use strict';
    ...
    var formFields = [
        ...
        },
        {
            ...
            templateOptions: {staticLabel: 'luae_na.label.vardenhet'},
            fieldGroup: [
