angular.module('luae_na').factory('aktivitetsersattning-na.UnderlagTypProxy',
    [ '$q', '$http', '$stateParams', '$log', '$location', '$window', '$timeout', '$uibModal', '$cookieStore',
        ...
        'common.UserModel',
        function($q, $http, $stateParams, $log, $location, $window, $timeout, $uibModal, $cookieStore, User, dialogService,
