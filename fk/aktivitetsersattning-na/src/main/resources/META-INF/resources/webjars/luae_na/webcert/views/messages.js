...
var aktivitetsersattningNAMessages = {
    'sv': {
        ...
        'luae_na.label.send.body': 'Upplys patienten om att även göra en ansökan om aktivitetsersattning-na hos Försäkringskassan.',
        'luae_na.button.send': 'Skicka till Försäkringskassan',

        // aktivitetsersattning-na
        ...
        //Labels
        'aktivitetsersattning-na.label.valj-version-icd-10': 'Välj version av ICD-10-SE:',
        'aktivitetsersattning-na.label.spara-utkast': 'Spara',
        'aktivitetsersattning-na.label.ta-bort-utkast': 'Ta bort utkast',
        'luae_na.label.skriv-ut-utkast': 'Skriv ut',

        'aktivitetsersattning-na.label.diagnoskod.icd': 'Diagnoskod enligt ICD-10 (huvuddiagnos): ',
        'aktivitetsersattning-na.label.diagnoskod.ksh': 'Diagnoskod enligt KSH97-P (Primärvård, huvuddiagnos): ',
        'aktivitetsersattning-na.label.diagnoskodverk.fullstandig': 'Fullständig version',
        'aktivitetsersattning-na.label.diagnoskodverk.primarvard': 'Primärvårdsversion',
        ...
        'luae_na.label.status.signed': 'Intyget är signerat. Intyget är nu tillgängligt för patienten i webbtjänsten Mina intyg, som nås via 1177.se. Intyget går även att nå via Försäkringskassans e-tjänst för ansökan om aktivitetsersattning-na. Om patienten inte har möjlighet att skicka intyget elektroniskt till Försäkringskassan kan du skicka intyget direkt till Försäkringskassan åt patienten. Observera att patientens samtycke då krävs.',
        ...
        // errors
        'aktivitetsersattning-na.error.could_not_load_cert': '<strong>Intyget gick inte att läsa in.</strong><br>Prova att ladda om sidan. Om problemet kvarstår, kontakta i första hand din lokala IT-avdelning och i andra hand Nationell kundservice på 0771-251010.',
        'aktivitetsersattning-na.error.could_not_load_cert_not_auth': '<strong>Kunde inte hämta intyget eftersom du saknar behörighet.</strong>',
        'aktivitetsersattning-na.error.could_not_load_cert_qa': '<strong>Frågor och svar för detta intyg gick inte att läsa in. Prova att ladda om sidan. Om problemet kvarstår, kontakta i första hand din lokala IT-avdelning och i andra hand Nationell kundservice på 0771-251010.</strong>',
        // fragaSvar errors
        'aktivitetsersattning-na.error.external_system_problem': '<strong>Meddelandet har inte skickats till Försäkringskassan då Webcert saknar kontakt med Försäkringskassans datasystem.</strong><br>Prova att skicka om meddelandet. Om problemet kvarstår, kontakta i första hand din lokala IT-avdelning och i andra hand Nationell kundservice på 0771-251010.',
        'aktivitetsersattning-na.error.internal_problem': '<strong>Ett tekniskt problem inträffade.</strong><br>Försök igen och kontakta supporten om problemet kvarstår.',
        'aktivitetsersattning-na.error.invalid_state': '<strong>Funktionen är inte giltig.</strong><br>Förmodligen har en annan användare ändrat informationen medan du arbetat på samma post. Ladda om informationen och försök igen',
        'aktivitetsersattning-na.error.unknown_internal_problem': '<strong>Ett tekniskt problem inträffade.</strong><br>Försök igen och kontakta supporten om problemet kvarstår.',
        'aktivitetsersattning-na.error.authorization_problem': '<strong>Du har inte behörighet att utföra funktionen, kontakta supporten för mer information.</strong>',
        'aktivitetsersattning-na.error.data_not_found': '<strong>Intyget kunde inte hittas i intygstjänsten.</strong><br>Intyget är borttaget eller så saknas behörighet.'

    },
    'en': {
        'aktivitetsersattning-na.label.pagetitle': 'Show Certificate'
    }
};
