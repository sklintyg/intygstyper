...
public final class ScenarioFinder {
    ...
    private static final class FileBasedScenario implements Scenario {
         ...
         */
        @Override
        public SjukpenningUtokadUtlatande asInternalModel()
                throws ScenarioNotFoundException {
            try {
                return new CustomObjectMapper().readValue(getInternalModelFor(scenarioFile), SjukpenningUtokadUtlatande.class);
            } catch (IOException e) {
