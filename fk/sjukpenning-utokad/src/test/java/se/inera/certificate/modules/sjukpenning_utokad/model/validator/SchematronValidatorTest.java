...
public class SchematronValidatorTest {
    ...
    public void brokenXmlFailsTest() throws Exception {
        String inputXml = Resources.toString(getResource("sjukpenning-utokat2_broken.xml"), Charsets.UTF_8);
    ...
    public void validXmlPassesTest() throws Exception {
        String inputXml = Resources.toString(getResource("sjukpenning-utokat2.xml"), Charsets.UTF_8);
        ValidateXmlResponse response = XmlValidator.validate(VALIDATOR, inputXml);
