...
package se.inera.certificate.modules.sjukpenning_utokad.model.utils;
...
public final class ResourceConverterUtils {
    ...
    public static SjukpenningUtokadUtlatande toInternal(File resource)
            throws IOException {
        return OBJECT_MAPPER.readValue(resource, SjukpenningUtokadUtlatande.class);
    }

    public static SjukpenningUtokadUtlatande toInternal(String resource)
            throws IOException {
        return OBJECT_MAPPER.readValue(resource, SjukpenningUtokadUtlatande.class);
    }
}
