angular.module('lisu').service('lisu.QACtrl.Helper',
    ['$log', '$timeout', 'lisu.fragaSvarService', 'common.fragaSvarCommonService', '$window', 'common.statService',
                    ...
                    if(qas) {
                        angular.forEach(qas, function(qa) { //unused parameter , key
                            ...
                            if(fromHandledDialog) {
                                qa.proxyMessage = 'lisu.fragasvar.marked.as.hanterad';
                            } else {
