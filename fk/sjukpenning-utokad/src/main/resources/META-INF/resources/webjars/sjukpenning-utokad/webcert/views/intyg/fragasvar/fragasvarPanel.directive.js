 ...
 */
angular.module('lisu').directive('qaPanelsp',
    [ '$window', '$log', '$timeout', 'common.User', 'common.fragaSvarCommonService', 'lisu.fragaSvarService',
        'common.statService', 'common.dialogService','lisu.QACtrl.Helper',
        function($window, $log, $timeout, User, fragaSvarCommonService, fragaSvarService, statService, dialogService, qaHelper) {
            ...
            return {
                ...
                transclude: true,
                replace: true,
                templateUrl: '/web/webjars/sjukpenning-utokad/webcert/views/intyg/fragasvar/fragasvarPanel.directive.html',
                scope: {
                    panelId: '@',
                    qa: '=',
                    qaList: '=',
                ...
                controller: function($scope, $element, $attrs) {
                    ...
                    $scope.sendAnswer = function sendAnswer(qa) {
                        ...
                        fragaSvarService.saveAnswer(qa, 'lisu', function(result) {
                            ...
                            if (result !== null) {
                                ...
                                addListMessage($scope.qaList, qa, 'lisu.fragasvar.answer.is.sent');
                    ...
                    $scope.onVidareBefordradChange = function(qa) {
                        ...
                        fragaSvarCommonService.setVidareBefordradState(qa.internReferens, 'lisu', qa.vidarebefordrad,
                            function(result) {
                            ...
                            function(qas){
                                if(qas) {
                                    angular.forEach(qas, function(qa) { //unused parameter , key
                                        ...
                                        //addListMessage(qas, qa, 'lisu.fragasvar.marked.as.hanterad'); // TODOOOOOOOO TEST !!!!!!!!!!
                                    });
                                    statService.refreshStat();
                                }
                    ...
                    $scope.updateAsHandled = function(qa, deferred) {
                        ...
                        fragaSvarService.closeAsHandled(qa.internReferens, 'lisu', function(result) {
                            qa.activeErrorMessageKey = null;
                            qa.updateHandledStateInProgress = false;
                            if (result !== null) {
                                fragaSvarCommonService.decorateSingleItem(result);
                                addListMessage($scope.qaList, qa, 'lisu.fragasvar.marked.as.hanterad');
                    ...
                    $scope.updateAsUnHandled = function(qa) {
                        ...
                        fragaSvarService.openAsUnhandled(qa.internReferens, 'lisu', function(result) {
                            ...
                            if (result !== null) {
                                fragaSvarCommonService.decorateSingleItem(result);
                                addListMessage($scope.qaList, qa, 'lisu.fragasvar.marked.as.ohanterad');
