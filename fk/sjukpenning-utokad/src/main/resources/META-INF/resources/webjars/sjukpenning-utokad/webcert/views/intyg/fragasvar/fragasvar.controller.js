angular.module('lisu').controller('lisu.QACtrl',
    [ '$log', '$rootScope', '$stateParams', '$scope', '$timeout', '$window', '$filter', 'common.dialogService',
        'lisu.fragaSvarService', 'common.fragaSvarCommonService', 'common.statService',
        'common.UserModel', 'lisu.QACtrl.Helper', 'common.IntygViewStateService',
        function($log, $rootScope, $stateParams, $scope, $timeout, $window, $filter, dialogService, fragaSvarService,
            ...
            fragaSvarService.getQAForCertificate($stateParams.certificateId, 'lisu', function(result) {
                ...
                if (result.length > 0) {
                    $rootScope.$emit('lisu.QACtrl.load', result[0].intygsReferens);
                }
            ...
            var unbindFastEvent = $rootScope.$on('lisu.ViewCertCtrl.load', function(event, cert, certProperties) {
                $scope.cert = cert;
            ...
            $scope.sendQuestion = function (newQuestion) {
                ...
                fragaSvarService.saveNewQuestion($stateParams.certificateId, 'lisu', newQuestion,
                    function(result) {
