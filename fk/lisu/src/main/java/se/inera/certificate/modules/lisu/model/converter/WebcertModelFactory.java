...
import se.inera.certificate.modules.lisu.support.LisuEntryPoint;
...
public class WebcertModelFactory {
    ...
    /**
     * Create a new lisu draft pre-populated with the attached data.
     *
     * @param newDraftData
    ...
    public LisuUtlatande createCopy(CreateDraftCopyHolder copyData, LisuUtlatande template) throws ConverterException {
        ...
        LisuUtlatande.Builder templateBuilder = template.toBuilder();
