...
package se.inera.certificate.modules.lisu.model.internal;
...
public abstract class LisuUtlatande implements Utlatande, SitUtlatande {
    ...
    public String getTyp() {
        return LisuEntryPoint.MODULE_ID;
    }
    ...
    /*
     * Retrieve a builder from an existing LisuUtlatande object. The builder can then be used
    ...
    public abstract static class Builder {
        ...
        public abstract LisuUtlatande build();
