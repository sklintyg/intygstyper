...
public final class TransportToInternal {
    ...
    public static LisuUtlatande convert(Intyg source) throws ConverterException {
    ...
    private static void setSvar(LisuUtlatande.Builder utlatande, Intyg source) throws ConverterException {
    ...
    private static void handleArbetsresor(LisuUtlatande.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
    ...
    private static void handleArbetstidsforlaggning(LisuUtlatande.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
    ...
    private static void handleForsakringsmedicinsktBeslutsstod(LisuUtlatande.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
    ...
    private static void handleFunktionsnedsattning(LisuUtlatande.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
    ...
    private static void handleArbetsmarknadspolitisktProgram(LisuUtlatande.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
    ...
    private static void handleNuvarandeArbete(LisuUtlatande.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
    ...
    private static void handleGrundForMedicinsktUnderlag(LisuUtlatande.Builder utlatande, Svar svar) throws ConverterException {
    ...
    private static void handleDiagnos(List<Diagnos> diagnoser, Svar svar) throws ConverterException {
        ...
        Diagnoskodverk diagnoskodverk = Diagnoskodverk.getEnumByCodeSystem(diagnosKodSystem, false);
        diagnoser.add(Diagnos.create(diagnosKod, diagnoskodverk.toString(), diagnosBeskrivning, diagnosDisplayName));
    }

    private static void handleAktivitetsbegransning(LisuUtlatande.Builder utlatande, Svar svar) {
    ...
    private static void handlePagaendeBehandling(LisuUtlatande.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handlePlaneradBehandling(LisuUtlatande.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleOvrigt(LisuUtlatande.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleOnskarKontakt(LisuUtlatande.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
