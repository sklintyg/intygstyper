...
import static se.inera.intyg.intygstyper.fkparent.model.validator.InternalToSchematronValidatorTestUtil.getXmlFromModel;
...
import se.inera.intyg.intygstyper.lisu.model.utils.Scenario;
...
public class InternalValidatorResultMatchesSchematronValidatorTest {
    ...
    private static void doInternalAndSchematronValidation(Scenario scenario, boolean fail) throws Exception {
        LisuUtlatande utlatandeFromJson = scenario.asInternalModel();
