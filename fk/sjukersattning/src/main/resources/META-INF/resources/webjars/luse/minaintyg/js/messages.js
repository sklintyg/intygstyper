...
var sjukersattningMessages = {
    'sv': {
        ...
        'luse.label.nedsattning': 'Jag bedömer att arbetsförmåga är (fält 8b)',
        ...
        'luse.label.smittskydd': 'Avstängning enligt smittskyddslagen på grund av smitta ',
        'luse.label.yes': 'Ja',
        'luse.label.no': 'Nej',
        'luse.label.anledningtillkontakt': 'Anledning till kontakt:',
        'luse.label.partialyes': 'Ja, delvis',
        'luse.label.diagnosis': 'Diagnos/diagnoser för sjukdom som orsakar nedsatt arbetsförmåga',
        'luse.label.diagnosiscode': 'Diagnoskod enligt ICD-10 (huvuddiagnos): ',
        'luse.label.ytterligarediagnoser': 'Ytterligare diagnoser',
        'luse.label.diagnosfortydligande': 'Förtydligande av diagnos/diagnoser',
        'luse.label.samsjuklighet': 'Samsjuklighet föreligger',
        'luse.label.progressofdesease': 'Aktuellt sjukdomförlopp (fält 3)',
        'luse.label.disabilities': 'Funktionsnedsättning - observationer, undersökningsfynd och utredningsresultat',
        'luse.label.basedon': 'Intyget baseras på (fält 2)',
        'luse.label.comment': 'Kommentar:',
        'luse.label.limitation': 'Aktivitetsbegränsning relaterat till diagnos och funktionsnedsättning',
        'luse.label.recommendations': 'Rekommendationer (fält 6a)',
        'luse.label.plannedtreatment': 'Planerad eller pågående behandling eller åtgärd',
        'luse.label.plannedtreatment.healthcare': 'Inom sjukvården:',
        'luse.label.plannedtreatment.avslutadbehandling': 'Avslutad behandling:',
        'luse.label.plannedtreatment.other': 'Annan åtgärd:',
        'luse.label.workrehab': 'Är arbetslivsinriktad rehabilitering aktuell?',
        'luse.label.unjudgeable': 'Går inte att bedöma',
        'luse.label.patientworkcapacity': 'Patientens arbetsförmåga bedöms i förhållande till',
        'luse.label.patientworkcapacity.currentwork': 'Nuvarande arbete: ',
        'luse.label.patientworkcapacity.unemployed': 'Arbetslöshet - att utföra sådant arbete som är normalt förekommande på arbetsmarknaden',
        'luse.label.patientworkcapacity.parentalleave': 'Föräldraledighet med föräldrapenning - att vårda sitt barn',
        'luse.label.patientworkcapacityjudgement': 'Patientens arbetsförmåga bedöms nedsatt längre tid än den som det försäkringsmedicinska beslutsstödet anger, därför att: ',
        'luse.label.prognosis': 'Prognos - kommer patienten att få tillbaka sin arbetsförmåga i nuvarande arbete? (Gäller inte arbetslösa)',
        'luse.label.prognos': 'Prognos',
        'luse.label.othertransport': 'Kan resor till och från arbetet med annat färdsätt än normalt göra det möjligt för patienten att återgå i arbete?',
        'luse.label.fkcontact': 'Kontakt önskas med Försäkringskassan ',
        'luse.label.workcodes': 'Förskrivarkod och arbetsplatskod',
        'luse.label.recommendations.contact.jobcenter': 'Kontakt med Arbetsförmedlingen',
        'luse.label.recommendations.contact.healthdepartment': 'Kontakt med företagshälsovården',
        'luse.label.recommendations.contact.other': 'Övrigt: ',
        'luse.label.reference.to.field13': 'Se under Övriga upplysningar och förtydliganden',
        'luse.label.otherinformation': 'Övriga upplysningar och förtydliganden',
        ...
        'luse.nedsattningsgrad.helt_nedsatt': 'Helt nedsatt',
        'luse.nedsattningsgrad.nedsatt_med_3_4': 'Nedsatt med 3/4',
        'luse.nedsattningsgrad.nedsatt_med_1_2': 'Nedsatt med hälften',
        'luse.nedsattningsgrad.nedsatt_med_1_4': 'Nedsatt med 1/4',
        'luse.vardkontakt.5880005': 'Min undersökning av patienten den %0',
        'luse.vardkontakt.undersokning': 'Min undersökning av patienten den ',
        'luse.vardkontakt.185317003': 'Min telefonkontakt med patienten den %0',
        'luse.vardkontakt.telefonkontakt': 'Min telefonkontakt med patienten den ',
        'luse.referens.419891008': 'Journaluppgifter, den %0',
        'luse.referens.journal': 'Journaluppgifter, den ',
        'luse.referens.kannedomompatient': 'Kännedom om patient, den ',
        'luse.referens.74964007': 'Annat, den %0',
        'luse.referens.annat': 'Annat, den ',
