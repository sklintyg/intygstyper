...
package se.inera.certificate.modules.sjukersattning.model.utils;
...
public final class ResourceConverterUtils {
    ...
    public static SjukersattningUtlatande toInternal(File resource)
            throws IOException {
        return OBJECT_MAPPER.readValue(resource, SjukersattningUtlatande.class);
    }

    public static SjukersattningUtlatande toInternal(String resource)
            throws IOException {
        return OBJECT_MAPPER.readValue(resource, SjukersattningUtlatande.class);
    }
}
