...
package se.inera.certificate.modules.luaefs.rest;
...
import se.inera.certificate.modules.luaefs.model.converter.InternalToNotification;
import se.inera.certificate.modules.luaefs.model.converter.InternalToTransport;
import se.inera.certificate.modules.luaefs.model.converter.TransportToInternal;
import se.inera.certificate.modules.luaefs.model.converter.WebcertModelFactory;
...
public class LuaefsModuleApi implements ModuleApi {
    ...
    public CertificateResponse getCertificate(String certificateId, String logicalAddress) throws ModuleException {
        ...
        try {
            ...
            String error = String.format("Could not get certificate with id %s and type luaefs from Intygstjansten. SOAPFault: %s",
