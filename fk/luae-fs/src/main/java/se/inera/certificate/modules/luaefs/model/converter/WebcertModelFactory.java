...
public class WebcertModelFactory {
    ...
    /**
     * Create a new luaefs draft pre-populated with the attached data.
     *
     * @param newDraftData
    ...
    public void updateSkapadAv(LuaefsUtlatande utlatande, HoSPersonal hosPerson, LocalDateTime signeringsdatum) {
