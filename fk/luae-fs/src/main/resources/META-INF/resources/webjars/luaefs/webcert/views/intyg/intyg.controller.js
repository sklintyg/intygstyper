angular.module('luaefs').controller('luaefs.ViewCertCtrl',
    [ '$log', '$rootScope', '$stateParams', '$scope', 'common.IntygService','common.IntygProxy',
        'common.messageService', 'common.UserModel', 'luaefs.IntygController.ViewStateService',
        'luaefs.FormFactory', 'common.dynamicLabelService',
        function($log, $rootScope, $stateParams, $scope, IntygService, IntygProxy,
            ...
            var unbindFastEventFail = $rootScope.$on('luaefs.ViewCertCtrl.load.failed', function(event, intyg) {
