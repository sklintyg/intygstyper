...
module.exports = function(config) {
    ...
    var SRC_DIR = 'src/main/resources/META-INF/resources/webjars/luaefs/webcert/views/';
    var TEST_DIR = 'src/main/resources/META-INF/resources/webjars/luaefs/webcert/';
    ...
    config.set({
        ...
        preprocessors: {
            'src/main/resources/META-INF/resources/webjars/luaefs/webcert/views/**/*.html': ['ng-html2js'],
            'src/main/resources/META-INF/resources/webjars/luaefs/webcert/**/*.js': ['coverage'],
