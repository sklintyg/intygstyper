angular.module('luaefs').factory('luaefs.FormFactory',
    ['luaefs.FormFactoryHelper',
        function(FactoryHelper) {
            ...
            var formFields = [
                ...
                },
                {
                    ...
                    fieldGroup: [
                        {
                            key: 'funktionsnedsattningBeskrivning',
                            type: 'single-text',
                            templateOptions: {label: 'DFR_8.1'}
                        },
                        {
                            key: 'funktionsnedsattningPaverkanSkolgang',
                            type: 'single-text',
                            templateOptions: {label: 'DFR_9.1'}
                        }
