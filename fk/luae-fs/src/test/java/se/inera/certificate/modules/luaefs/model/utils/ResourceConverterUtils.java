...
package se.inera.certificate.modules.luaefs.model.utils;
...
public final class ResourceConverterUtils {
    ...
    public static LuaefsUtlatande toInternal(File resource)
            throws IOException {
        return OBJECT_MAPPER.readValue(resource, LuaefsUtlatande.class);
    }

    public static LuaefsUtlatande toInternal(String resource)
            throws IOException {
        return OBJECT_MAPPER.readValue(resource, LuaefsUtlatande.class);
    }
}
