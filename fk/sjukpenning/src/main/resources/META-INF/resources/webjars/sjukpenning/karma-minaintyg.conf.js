...
module.exports = function(config) {
    ...
    var SRC_DIR = 'src/main/resources/META-INF/resources/webjars/sjukpenning/minaintyg/js/';
    ...
    config.set({
        ...
        preprocessors: {
            'src/main/resources/META-INF/resources/webjars/sjukpenning/minaintyg/js/**/*.js': ['coverage']
        },
