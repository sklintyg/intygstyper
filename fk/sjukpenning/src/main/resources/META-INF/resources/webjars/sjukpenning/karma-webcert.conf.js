...
module.exports = function(config) {
    ...
    var SRC_DIR = 'src/main/resources/META-INF/resources/webjars/sjukpenning/webcert/views/';
    var TEST_DIR = 'src/main/resources/META-INF/resources/webjars/sjukpenning/webcert/';
    ...
    config.set({
        ...
        preprocessors: {
            'src/main/resources/META-INF/resources/webjars/sjukpenning/webcert/views/**/*.html': ['ng-html2js'],
            'src/main/resources/META-INF/resources/webjars/sjukpenning/webcert/**/*.js': ['coverage']
        },
