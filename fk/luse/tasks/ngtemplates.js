module.exports = {
    webcert: {
        ...
        src: ['**/*.html'],
        dest: 'build/resources/main/META-INF/resources/webjars/luse/webcert/templates.js',
        options:{
            module: 'luse',
            url: function(url) {
    ...
    minaintyg: {
        ...
        src: ['**/*.html'],
        dest: 'build/resources/main/META-INF/resources/webjars/luse/minaintyg/templates.js',
        options:{
            module: 'luse',
            url: function(url) {
