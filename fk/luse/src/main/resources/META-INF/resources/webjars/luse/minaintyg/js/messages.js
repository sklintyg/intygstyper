...
angular.module('luse').constant('luse.messages', {
    'sv': {
        ...
        'luse.recipient.label.inactive.recipient': 'Varför går det inte att skicka intyget till vissa mottagare?',
        ...
        'luse.recipient.label.downloadlink': 'Ladda ner / Skriv ut',
        ...
        'luse.label.pagedescription.save.or.print.certificate': 'Klicka på knappen Ladda ner/Skriv ut för att spara eller skriva ut ditt intyg. Intyget öppnas eller laddas ner som en pdf-fil som du kan spara på din dator eller skriva ut.',
        ...
        'luse.button.downloadprint': 'Ladda ner / Skriv ut',
