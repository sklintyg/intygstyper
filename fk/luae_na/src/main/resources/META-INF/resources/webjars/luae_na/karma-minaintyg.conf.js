...
module.exports = function(config) {
    ...
    var SRC_DIR = 'src/main/resources/META-INF/resources/webjars/luae_na/minaintyg/js/';
    ...
    config.set({
        ...
        preprocessors: {
            'src/main/resources/META-INF/resources/webjars/luae_na/minaintyg/js/**/*.js': ['coverage']
        },
