...
module.exports = function(config) {
    ...
    var SRC_DIR = 'src/main/resources/META-INF/resources/webjars/luae_na/webcert/views/';
    var TEST_DIR = 'src/main/resources/META-INF/resources/webjars/luae_na/webcert/';
    ...
    config.set({
        ...
        preprocessors: {
            'src/main/resources/META-INF/resources/webjars/luae_na/webcert/views/**/*.html': ['ng-html2js'],
            'src/main/resources/META-INF/resources/webjars/luae_na/webcert/**/*.js': ['coverage'],
