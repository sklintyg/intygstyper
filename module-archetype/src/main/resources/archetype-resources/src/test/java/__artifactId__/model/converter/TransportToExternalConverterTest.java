...
public class TransportToExternalConverterTest {
    ...
    private se.inera.certificate.${artifactId}.v1.Arrangemang buildArrangemang() {

        se.inera.certificate.${artifactId}.v1.Arrangemang arr = new se.inera.certificate.${artifactId}.v1.Arrangemang();
    ...
    public void testConvertArrangemang() throws ConverterException {
        se.inera.certificate.${artifactId}.v1.Arrangemang transportArr = buildArrangemang();
