...
public class XmlToExternalTest {
    ...
    public void testXmlToExternalExample2() throws ConverterException {
        converter.transportToExternal(unmarshallXml("${artifactId}-example-2.xml"));

    }

    @Test
    public void testXmlToExternal() throws ConverterException {
        Utlatande extUtlatande = converter.transportToExternal(unmarshallXml("${artifactId}-example-1.xml"));
