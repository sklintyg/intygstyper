...
import ${package}.${artifactId}.model.external.Arrangemang;
...
public class ExternalToInternalConverterTest {
    ...
    public void testConvertUtlatande() throws Exception {
        ...
        Utlatande extUtlatande = readUtlatandeFromJsonFile("/${artifactId}-example-1.json");

        ${package}.${artifactId}.model.internal.mi.Utlatande res = converter
    ...
    public void testConvertToIntPatient()  throws Exception {
        ...
        ${package}.${artifactId}.model.internal.mi.Patient res = converter.convertToIntPatient(extPatient);
    ...
    public void testConvertToIntArrangemang() throws Exception {
        ...
        ${package}.${artifactId}.model.internal.mi.Arrangemang res = converter.convertToIntArrangemang(extArr);
    ...
    public void testConvertToIntVardenhet() throws Exception {
        ...
        ${package}.${artifactId}.model.internal.mi.Vardenhet res = converter.convertToIntVardenhet(extVardenhet);
