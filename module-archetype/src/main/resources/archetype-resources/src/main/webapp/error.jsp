...
<body>
  ...
  <!-- 
  Error:
   <c:out value="${symbol_dollar}{pageContext.errorData.throwable.message}" />, 
   
   Stacktrace:
  <c:forEach items="${symbol_dollar}{pageContext.errorData.throwable.stackTrace}" var="element">
    <c:out value="${symbol_dollar}{element}" />, 
    </c:forEach>
-->
</body>
</html>
