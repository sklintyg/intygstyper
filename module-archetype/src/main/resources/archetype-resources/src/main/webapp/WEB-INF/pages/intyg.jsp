...
<title ng-bind="${symbol_dollar}root.page_title"><spring:message code="application.name" /></title>
...
<body ng-app="RLIViewCertApp">
 ...
 <![endif]-->
  ...
  <script type="text/javascript" src="<c:url context="/m/${artifactId}" value="/intyg/js/${artifactId}-app.js"/>"></script>
  <script type="text/javascript" src="<c:url context="/m/${artifactId}" value="/intyg/js/controllers.js"/>"></script>
  <script type="text/javascript" src="<c:url context="/m/${artifactId}" value="/intyg/js/messages.js"/>"></script>
