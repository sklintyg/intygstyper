...
public interface ModuleApi {
    ...
    Utlatande unmarshall(se.inera.certificate.${artifactId-safe}.model.v1.Utlatande transportModel);
    ...
    se.inera.certificate.${artifactId-safe}.model.v1.Utlatande marshall(Utlatande externalModel);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    ${package}.${artifactId-safe}.model.external.Utlatande convertInternalToExternal(
