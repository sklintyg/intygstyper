...
import ${package}.${artifactId}.model.codes.BefattningsKod;
import ${package}.${artifactId}.model.codes.CodeConverter;
import ${package}.${artifactId}.model.codes.HSpersonalKod;
import ${package}.${artifactId}.model.codes.CodeSystem;
...
import ${package}.${artifactId}.model.codes.UtlatandeKod;
