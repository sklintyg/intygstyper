...
public interface ModuleApi {
    ...
    Utlatande unmarshall(se.inera.certificate.ts_diabetes.model.v1.Utlatande transportModel);
    ...
    se.inera.certificate.ts_diabetes.model.v1.Utlatande marshall(Utlatande externalModel);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    se.inera.certificate.modules.ts_diabetes.model.internal.Utlatande convertExternalToInternal(
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    se.inera.certificate.modules.ts_diabetes.model.external.Utlatande convertInternalToExternal(
