...
<head>
	...
	<script type="text/javascript">
	    ...
	    var MODULE_CONFIG = {
            ...
            MODULE_CONTEXT_PATH : '/m/ts-diabetes',
            CERT_ID_PARAMETER : '<c:out value="${id}"/>'
	    }
	</script>
</head>

<body ng-app="TSDiabetesCertApp">

    <a id="top"></a>
    <div class="container-fluid">

        <div class="row-fluid">
            <div class="span12 webcert-col webcert-col-single">
    ...
    <script type="text/javascript" src="/js/vendor/angular/1.1.5/angular-cookies.min.js"></script>
    ...
    <script type="text/javascript" src="<c:url value="/webcert/js/ts-diabetes-app.js"/>"></script>
