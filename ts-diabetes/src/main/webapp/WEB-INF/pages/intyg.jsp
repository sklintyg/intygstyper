...
<script type="text/javascript">
    ...
    var MODULE_CONFIG = {
        ...
        PROXY_PREFIX : '/m/ts-diabetes' //maybe from serverside config?
    }
</script>
</head>
...
<body ng-app="RLIViewCertApp">
 ...
 <![endif]-->
  ...
  <script type="text/javascript" src="<c:url context="/m/ts-diabetes" value="/intyg/js/ts-diabetes-app.js"/>"></script>
  <script type="text/javascript" src="<c:url context="/m/ts-diabetes" value="/intyg/js/controllers.js"/>"></script>
  <script type="text/javascript" src="<c:url context="/m/ts-diabetes" value="/intyg/js/messages.js"/>"></script>
