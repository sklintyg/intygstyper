  ...
  <xsl:template match="ns2:intyg">
    ...
    <!-- REKOMMENDATIONER begin -->
      ...
      <p:rekommendation>
        <p:rekommendationskod code="REK8"
          codeSystem="{$id_kv_rekommendation_intyg}" codeSystemName="kv_rekommendation_intyg" />
        <xsl:choose>
    ...
    <!-- OBSERVATIONER begin -->
      ...
      <xsl:if test="ns1:diabetes/ns1:harBehandlingTabletter = 'true' or ns1:diabetes/ns1:harBehandlingTabletter = '1'">
        <p:observation>
          <p:observationskod code="170746002" codeSystem="{$id_snomed-ct}"
      ...
      <xsl:if test="ns1:diabetes/ns1:harBehandlingKost = 'true' or ns1:diabetes/ns1:harBehandlingKost = '1'">
        <p:observation>
          <p:observationskod code="170745003" codeSystem="{$id_snomed-ct}"
            codeSystemName="SNOMED-CT" />
          <p:forekomst>true</p:forekomst>
        </p:observation>
      </xsl:if>
      ...
      <xsl:if test="ns1:diabetes/ns1:harBehandlingInsulin = 'true' or ns1:diabetes/ns1:harBehandlingInsulin = '1'">
          <p:observation>
            <p:observationskod code="170747006" codeSystem="{$id_snomed-ct}"
                codeSystemName="SNOMED-CT"/>
            <p:observationsperiod>
              <p3:from>
      ...
      <xsl:if test="ns1:separatOgonLakarintygKommerSkickas = 'false' or ns1:separatOgonLakarintygKommerSkickas = '0'">
        <p:observation>
          ...
          <p:observation>
            <p:observationskod code="420050001" codeSystem="{$id_snomed-ct}"
                codeSystemName="SNOMED-CT"/>
            <p:varde>
              <xsl:attribute name="value" select="ns1:synfunktion/ns1:synskarpaUtanKorrektion/ns1:hogerOga"/>
            </p:varde>
            <p2:lateralitet code="24028007" codeSystem="{$id_snomed-ct}"
                codeSystemName="SNOMED-CT"/>
          </p:observation>
          ...
          <p:observation>
            ...
            <p2:lateralitet code="7771000" codeSystem="{$id_snomed-ct}"
                codeSystemName="SNOMED-CT"/>
          </p:observation>
          ...
          <p:observation>
            ...
            <p2:lateralitet code="51440002" codeSystem="{$id_snomed-ct}"
                codeSystemName="SNOMED-CT"/>
          </p:observation>

          <!-- Med korrektion --><!-- Höger öga -->
          <p:observation>
            <p:observationskod code="397535007" codeSystem="{$id_snomed-ct}"
                codeSystemName="SNOMED-CT"/>
            <p:varde>
