...
angular.module('controllers.ts-diabetes.ViewCertCtrl').controller('ViewCertCtrl', [ '$scope', '$filter', '$location', 'certService', '$http', function ViewCertCtrl($scope, $filter, $location, certService, http) {
    $scope.cert = {};
