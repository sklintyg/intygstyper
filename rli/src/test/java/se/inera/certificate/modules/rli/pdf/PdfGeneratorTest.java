...
public class PdfGeneratorTest {
    ...
    public PdfGeneratorTest() {
        this.pdfGen = new PdfGeneratorImpl();
    }

    @Test
    public void testPdfGenerator() throws PdfGeneratorException, IOException{
        
        Utlatande utlatande = buildInternalUtlatande();
    ...
    private void writePdfToFile(byte[] pdf) throws IOException {
        ...
        File file = new File(dir + "/RLI_intyg_" + LocalDateTime.now().toString("yyyyMMdd_HHmm") + ".pdf");
