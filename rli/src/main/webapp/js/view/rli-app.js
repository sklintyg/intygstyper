 ...
 */
var RLIApp = angular.module('RLIViewCertApp', [ 'ui.bootstrap', 'services.certService', 'controllers.rli.ViewCertCtrl', 'directives.mi', 'directives.message' ]).config([ '$routeProvider', function($routeProvider) {
