define([ 'angular' ], function(angular) {
     ...
     */
    var messages = angular.module(moduleName, []);
    messages.factory('messageService', [ '$rootScope',
        function($rootScope) {
    ...
    messages.directive('message', ['$rootScope', '$log', 'messageService',
        function($rootScope, $log, messageService) {
