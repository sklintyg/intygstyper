define([
    ...
    var moduleName = 'common.fragaSvarCommonService';
    ...
    angular.module(moduleName, []).
        factory(moduleName, [ '$http', '$log', '$modal', '$window',
            function($http, $log, $modal, $window) {
                ...
                function _showVidarebefordradPreferenceDialog(title, bodyText, yesCallback, noCallback,
                    noDontAskCallback, callback) {
