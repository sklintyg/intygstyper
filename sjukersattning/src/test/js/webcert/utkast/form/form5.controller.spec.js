describe('sjukersattning.EditCertCtrl.Form5Ctrl', function() {
    'use strict';
    ...
    beforeEach(angular.mock.inject([
        ...
        function( $controller, _$rootScope_, _$httpBackend_, _$log_, _model_, _viewState_) {
            ...
            $controller('sjukersattning.EditCert.Form5Ctrl' , { $scope: $scope, $log : $log, model : model, viewState : viewState });
