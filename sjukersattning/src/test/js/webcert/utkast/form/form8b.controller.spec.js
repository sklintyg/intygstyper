describe('sjukersattning.EditCertCtrl.Form8bCtrl', function() {
    'use strict';
    ...
    beforeEach(angular.mock.module('common', 'sjukersattning', 'htmlTemplates', function($provide) {
    ...
    describe('#Intygdata gets done loading after controller is initialized', function() {
        ...
        beforeEach(angular.mock.inject([
            ...
            function( $compile, $templateCache, $controller, _$rootScope_, _$http_, _$httpBackend_, _$log_, _model_, _viewState_) {
                ...
                var viewHtml = $templateCache.get('/web/webjars/sjukersattning/webcert/views/utkast/form/form8b.html');
