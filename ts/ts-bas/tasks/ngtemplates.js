...
module.exports = {
    webcert: {
        ...
        src: ['**/*.html'],
        dest: 'build/resources/main/META-INF/resources/webjars/ts-bas/webcert/templates.js',
        options:{
            module: 'ts-bas',
            url: function(url) {
    ...
    minaintyg: {
        ...
        src: ['**/*.html'],
        dest: 'build/resources/main/META-INF/resources/webjars/ts-bas/minaintyg/templates.js',
        options:{
            module: 'ts-bas',
            url: function(url) {
