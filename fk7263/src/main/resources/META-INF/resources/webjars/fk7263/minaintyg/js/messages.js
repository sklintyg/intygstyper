...
define([], function() {
    ...
    return {
        'sv': {
            ...
            'fk7263.label.latestevent': 'Senaste händelsen med intyget',
            ...
            'fk7263.label.status.false': '<span class="glyphicon glyphicon-chevron-up"></span><a> Dölj information</a>',
            'fk7263.label.status.true': '<span class="glyphicon glyphicon-chevron-down"></span><a> Visa information</a>',
            'fk7263.label.showevents.false': '<span class="glyphicon glyphicon-chevron-up"></span><a> Visa färre händelser</a>',
            'fk7263.label.showevents.true': '<span class="glyphicon glyphicon-chevron-down"></span><a> Visa alla händelser</a>',
