define(
    ...
    function () {
        ...
        return [
            '$scope', '$rootScope', '$log', '$timeout', '$window', 'fk7263.fragaSvarService', 'fragaSvarCommonService',
            ...
            function ($scope, $rootScope, $log, $timeout, $window, fragaSvarService, fragaSvarCommonService,
                ...
                var decorateSingleItem = function (qa) {
                    if (qa.amne === "PAMINNELSE") {
                        ...
                        qa.answerDisabledReason = undefined; // Påminnelser kan inte besvaras men det behöver
                        // vi inte säga
