define([
    ...
    'webjars/fk7263/webcert/js/services/fragaSvarService',
...
], function(angular, ViewCertCtrl, fragaSvarService, dialogService, fragaSvarCommonService, ManageCertView, statService,
    User) {
    'use strict';

    var moduleName = 'fk7263.QACtrl';

    angular.module(moduleName,
        [ dialogService, fragaSvarService, fragaSvarCommonService, ManageCertView, statService, User, ViewCertCtrl]).
        controller(moduleName, ['$log', '$rootScope', '$routeParams', '$scope', '$timeout', '$window', dialogService,
            fragaSvarService, fragaSvarCommonService, ManageCertView, statService, User,
            function($log, $rootScope, $routeParams, $scope, $timeout, $window, dialogService, fragaSvarService,
                ...
                var unbindFastEvent = $rootScope.$on(ViewCertCtrl + '.load', function(event, metaData) {
