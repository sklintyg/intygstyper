define(['angular', 'text!./qa.html'], function(angular, template) {
    'use strict';

    return ['$log', '$timeout', '$window', 'fk7263.fragaSvarService', 'fragaSvarCommonService',
        'wcDialogService', 'User', '$routeParams', 'statService',
        function($log, $timeout, $window, fragaSvarService, fragaSvarCommonService, wcDialogService,
