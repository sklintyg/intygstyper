...
var fk7263Messages = {
    'sv': {
        ...
        'fk7263.label.status.sent': 'Intyget är signerat och har skickats till Försäkringskassans system.',
        ...
        'fk7263.helptext.sista-giltighets-datum': 'Från och med datum är satt baserat på förra intygets sista giltighetsdag',
        ...
        'fk7263.validation.nedsattning.incorrect-date-interval': 'Ett datuminterval har angetts på ett felaktigt sätt (startdatum efter slutdatum). (Fält 8b)',
