...
/**
 * Converter to convert from legacy RegisterMedicalCertificate Jaxb -> RegistreraIntyg Jaxb
 * @author andreaskaltenbach, marced
 */
public final class LegacyTransportJaxbToGenericTransportJaxbConverter {

    public static final String FK_7263 = "fk7263";

    private LegacyTransportJaxbToGenericTransportJaxbConverter() {
    }

    /**
     * Converts a JAXB {@link LakarutlatandeType} to a {@link se.inera.certificate.common.v1.Utlatande}.
     */
    public static Utlatande convert(Lakarutlatande source) {
