 ...
 */
    public enum Prognos {
        ...
        Prognos(int id, String transportId, String label) {
            this.id = id;
        ...
        @JsonCreator
        public static Prognos fromId(@JsonProperty("id") int id) {
        ...
        public static Prognos fromTransportId(String transportId) {
            for (Prognos typ : values()) {
