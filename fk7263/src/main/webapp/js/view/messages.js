...
var fk7263Messages = {
    "sv": {
        ...
        "view.label.yes": "Ja",
        "view.label.no": "Nej",
        "view.label.diagnosis": "Diagnos/dianoser för sjukdom som orsakar nedsatt arbetsförmåga",
        "view.label.diagnosiscode": "Diagnoskod",
        "view.label.progressofdesease": "Aktuellt sjukdomförlopp",
        ...
        "view.label.limitation": "Aktivitetsbegräsning relaterat till diagnos (fält 2) och funktionsnedsättning (fält 4)",
