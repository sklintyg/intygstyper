 ...
 */
var FK7263App = angular.module('FK7263ViewCertApp', [ 'ui.bootstrap', 'services.certService', 'controllers.fk7263.ViewCertCtrl', 'directives.message' ]).config([ '$routeProvider', function($routeProvider) {
