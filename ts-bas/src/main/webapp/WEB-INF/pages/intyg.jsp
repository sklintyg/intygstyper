...
<body ng-app="RLIViewCertApp">
 ...
 <![endif]-->
  ...
  <script type="text/javascript" src="<c:url context="/m/ts-bas" value="/intyg/js/ts-bas-app.js"/>"></script>
  <script type="text/javascript" src="<c:url context="/m/ts-bas" value="/intyg/js/controllers.js"/>"></script>
  <script type="text/javascript" src="<c:url context="/m/ts-bas" value="/intyg/js/messages.js"/>"></script>
