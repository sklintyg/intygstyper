...
module.exports = function(grunt) {
    ...
    minaintyg = [SRC_DIR + 'webjars/ts-bas/minaintyg/js/module.js', DEST_DIR + 'webjars/ts-bas/minaintyg/templates.js'].concat(minaintyg);

    var webcert = grunt.file.readJSON(SRC_DIR + 'webjars/ts-bas/webcert/module-deps.json').map(function(file) {
        return file.replace(/\/web\//g, SRC_DIR);
    });
    webcert = [SRC_DIR + 'webjars/ts-bas/webcert/module.js', DEST_DIR + 'webjars/ts-bas/webcert/templates.js'].concat(webcert);
